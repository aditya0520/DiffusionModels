...
class DDPMScheduler(nn.Module):
    ...
    def step(
        ...
        pred_original_sample_coeff = torch.sqrt(alpha_prod_t_prev) * current_beta_t / (1 - alpha_prod_t_prev)
        current_sample_coeff = torch.sqrt(current_alpha_t) * (1 - alpha_prod_t_prev) / (1 - alpha_prod_t_prev)
